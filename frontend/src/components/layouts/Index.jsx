...
const Index = () => {
    const commonStyles = 'light-transition m-0.5 min-h-[70px] px-2 flex justify-center items-center text-[20px] font-semibold text-white bg-[#ffffff33] hover:bg-[#ffffff55] hover:text-[22px] hover:text-[#eee]'
